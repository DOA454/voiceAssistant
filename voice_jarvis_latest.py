...
def create_gui():
    ...
    window.title('Team 4 Voice Assistant Demo')
   # Set window size
    ...
    button1 = Button(window, text = 'HELLO', command = main , style='W.TButton')
    ...
    button2 = Button(window, text = 'GOODBYE', command = stop, style='S.TButton')
    button2.grid(row = 6, column = 3, pady = 10, padx = 100)
    button2.place(relx=0.5, rely=0.5, anchor=CENTER)

    label_font = ('Open Sans', 12)
    label1 = Label(window, text='Virtual Assistant : Jarvis', font = label_font)
    label2 = Label(window, text='Welcome, How can I help you?', font = label_font)
    label1.pack()
    label2.pack()
...
def close_app(app_name):    
    ...
    # else:
    #     respond(f"Unable to find {app_name} ") 
